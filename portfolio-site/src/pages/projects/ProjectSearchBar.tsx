...
function ProjectSearchBar(props: ProjectSearchBarProps): JSX.Element {
    return (
        <div className="flex flex-col items-center gap-[20px] pb-[40px] pt-[60px]">
            ...
            <input type="text" placeholder="Search project name, description, or skills used" onChange={props.onSearchUpdate} className="border-1 rounded-full w-[650px] px-[40px] py-[15px] text-[24px] font-light" id="project-search-input"/>
        </div>
    );
}
